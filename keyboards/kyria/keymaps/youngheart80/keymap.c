 ...
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |Tab/MEH |   A  |   R  |  S   |   T  |   D  |                              |   H  |   N  |   E  |   I  |  O   |  ' "   |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * | SpcCad |Z/Ctrl| X/Alt|   C  |   V  |   B  | UNDO | CAPM |  |ADJUST|LEADER|   K  |   M  | ,  < | . >  | /  ? | SpcCad |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | GUI  | NAV  | NUM  | Bspc | Del  |  | NAV  | Space| Enter| SYMB |      |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 */
    [_COLEMAK] = LAYOUT(
      ...
      KC_LSPO, KC_ZC  , KC_XA  , KC_C   , KC_V   , KC_B   , KC_UNDO, KC_CAPM, KC_ADJ , KC_LEAD, KC_K   , KC_M   , KC_COMM, KC_DOT , KC_SLSC, KC_RSPC,
                                 KC_LGUI, KC_NAV , KC_NUM , KC_BSPC, KC_DEL , KC_NAV , KC_SPC , KC_ENT , KC_SYMB, KC_LOCK
    ),
/*
 * Navigation Layer: Update graphic (TODO)
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |        |  !   |  @   |  {   |  }   |  |   |                              |      |      |      |      |      |  | \   |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 ...
 */
    [_NAV] = LAYOUT(
      KC_CAD , _______, KC_STAB, KC_TAB, _______, _______,                                     KC_PGUP, KC_HOME, KC_UP  , KC_END , KC_INS , _______,
